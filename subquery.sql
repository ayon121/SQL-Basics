...
--   to find highest HR salary from employees
SELECT * FROM employees ORDER BY salary DESC;
-- Result : Matthew Brown - HR - 63000 
...
-- A subquery (also called an inner query) is a query nested inside another query. It's useful when you need to use the result of one query inside another.
